...
CREATE TABLE "UserMedia" (
    ...
    CONSTRAINT "UserMedia_pkey" PRIMARY KEY ("userId","mediaId")
);
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_replyOnId_fkey" FOREIGN KEY ("replyOnId") REFERENCES "Comment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
